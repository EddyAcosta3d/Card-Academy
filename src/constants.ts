  ...
  '2': [
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_esp_2_inter', title: 'Debate Estructurado', description: 'Prepara argumentos para un tema.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Elige un tema de debate polémico pero escolar (por ejemplo, ¿uniforme escolar obligatorio o libre?, o ¿comida chatarra en cooperativa sí o no?).\n2. En tu libreta, divide la hoja en dos columnas: Argumentos a Favor y Argumentos en Contra.\n3. Escribe al menos 2 argumentos fuertes y claros en cada columna con buena letra.\n4. Al final de la página, escribe tu postura personal en 2 renglones explicando por qué elegiste ese lado.\n5. Toma una foto nítida de tu libreta y súbela aquí.' },
    ...
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_mat_2_inter', title: 'Gráficas Lineales', description: 'Interpreta puntos de equilibrio.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. En tu libreta de Matemáticas, dibuja un plano cartesiano (ejes X e Y) utilizando una regla.\n2. Traza la línea de la ecuación y = 2x + 1 para los valores de x desde -2 hasta 3.\n3. Haz una pequeña tabla de datos a un lado de tu gráfica mostrando los puntos calculados (x, y).\n4. Usa colores diferentes para el eje, la línea de la gráfica y los puntos.\n5. Sube una foto de tu plano cartesiano dibujado en tu cuaderno.' },
    ...
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_tec_2_inter', title: 'Página Web Simple', description: 'Maquetado en papel de una web.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Imagina que vas a crear una página web para tu escuela secundaria Jacobo.\n2. En una hoja limpia de tu cuaderno, dibuja el boceto o diseño visual ("mockup") de la página de inicio.\n3. Debe incluir: un encabezado con el logo y nombre de la escuela, un menú con 3 botones (Inicio, Alumnos, Contacto), una imagen central grande, y un pie de página con tus datos.\n4. Señala con flechas qué color usarías en cada sección y para qué sirve cada botón.\n5. Toma una foto completa de tu diseño en papel y súbela.' },
    ...
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_fce_2_inter', title: 'Juez por un Día', description: 'Resuelve un caso ético escolar.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Lee la siguiente situación: "Un alumno tomó sin permiso un sacapuntas del escritorio del profesor porque no tenía con qué trabajar. Otro compañero lo vio pero no sabe si decirle al maestro o quedarse callado."\n2. En tu libreta, escribe un escrito de 1 párrafo resolviendo el caso como si fueras un juez justo.\n3. Responde de forma clara:\n   - ¿Qué valor ético se rompió?\n   - ¿Qué solución propones que sea justa para el maestro, el alumno que tomó el objeto y el compañero testigo?\n4. Asegúrate de escribir tu nombre arriba de la hoja, tómale foto y súbela.' },
  ...
  '3': [
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_esp_3_inter', title: 'Guion Dramático', description: 'Escribe una escena de teatro.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Elige una pequeña anécdota divertida que haya pasado en tu salón de clases de la escuela Jacobo.\n2. Redacta en tu libreta un guion teatral de 1 página con 2 personajes.\n3. Debe incluir: título de la obra, acotaciones entre paréntesis (ej. "entra corriendo", "sonríe") y los diálogos claros de cada personaje indicando su nombre al inicio de la línea.\n4. Cuida mucho que tu letra sea legible y las palabras estén bien escritas. Sube una foto nítida.' },
    ...
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_mat_3_inter', title: 'Semejanza', description: 'Mide la sombra de un poste.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Sal al patio de tu casa o escuela de día.\n2. Mide con una cinta métrica o regla tu propia estatura y la longitud de tu sombra en el suelo en ese momento.\n3. Mide la longitud de la sombra de un poste, árbol u objeto alto que esté cerca.\n4. Utilizando el teorema de semejanza de triángulos, calcula la altura real de ese objeto alto (Altura_Objeto = Tu_Estatura * Sombra_Objeto / Tu_Sombra).\n5. Escribe la fórmula y el procedimiento paso a paso en tu libreta, tómale foto y súbela.' },
    ...
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_his_3_inter', title: 'Ensayo Globalización', description: 'Impacto económico en México.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Escribe en tu libreta un escrito de 2 párrafos sobre cómo influye la globalización en tu vida diaria.\n2. En el primer párrafo, menciona 3 productos extranjeros que uses mucho (marcas de ropa, tenis, alimentos o redes sociales).\n3. En el segundo párrafo, reflexiona sobre cómo estos productos afectan a los comerciantes y tiendas locales de tu colonia en México.\n4. Firma el escrito con tu nombre y súbelo para que tu profesor lo apruebe.' },
    ...
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_tec_3_inter', title: 'Prototipo de App', description: 'Dibuja 5 pantallas de una app.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. Imagina una aplicación móvil que sea súper útil para tus compañeros de la escuela Jacobo (como una app para compartir libros, reportar basura o estudiar química).\n2. En una página de tu cuaderno, dibuja 5 pantallas sencillas conectadas con flechas que muestren el recorrido básico (Pantalla de inicio, Registro, Menú principal y 2 pantallas con funciones).\n3. Agrega colores y notas breves explicando qué hace cada botón.\n4. Sube una foto clara de tu diseño de app en papel.' },
          { id: 'task_tec_3_hard', title: 'Impresión 3D', description: 'Diseño CAD en papel de una pieza útil.', difficulty: 'Hard', type: 'Exercise', evidenceRequired: true, reward: { tokens: 150, pack: true }, instructions: '1. Piensa en una pieza escolar rota o que haga falta en el plantel (un pf_1 o perchero para las mochilas, una pieza para reparar la persiana, o un estuche organizador de plumones para el pizarrón).\n2. En una página completa de tu libreta, dibuja un "Plano Técnico tridimensional" (isométrico) de este objeto de forma limpia.\n3. Rotula las medidas principales que debería tener (alto, ancho, profundidad, grosor de las paredes) pensadas en centímetros reales.\n4. Señala de qué material sugerirías fabricarlo para que no se rompa (plástico rígido PLA, filamento flexible, etc.).\n5. Sube la foto del plano.' }
        ]
      }]
    },
    {
      ...
      topics: [{
        ...
        tasks: [
          ...
          { id: 'task_fce_3_inter', title: 'Campaña Social', description: 'Crea un poster contra el bullying.', difficulty: 'Medium', type: 'Exercise', evidenceRequired: true, reward: { tokens: 50 }, instructions: '1. En una hoja limpia de tu cuaderno, dibuja y decora un póster llamativo con el lema: "¡Aquí todos somos Jacobo, dile NO al bullying!".\n2. El póster debe incluir: una frase positiva de compañerismo, un dibujo central coloreado (por ejemplo, manos unidas o caras felices) y 3 reglas básicas de respeto para el salón de clases.\n3. Usa marcadores o colores brillantes para que sea muy vistoso.\n4. Sube una foto nítida de tu póster escolar.' },
